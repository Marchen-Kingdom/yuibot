...
import yuibot
from yuibot import Service, aiorequests, priv

sv = Service(
    "deepchat", manage_priv=priv.SUPERUSER, enable_on_default=False, visible=False
)
...
async def deepchat(bot, ctx):
    ...
    api = yuibot.config.deepchat.deepchat_api
