...
from yuibot import Service, aiorequests, logger, priv
...
async def search_flac(bot, ev: CQEvent):
    ...
    resp = await aiorequests.get(
        "http://mtage.top:8099/acg-music/search",
    ...
    if res["success"] is False:
        ...
        await bot.finish(
            ev, f"查询失败 请至acgjc官网查询 www.acgjc.com/?s={quote(keyword)}", at_sender=True
        )
