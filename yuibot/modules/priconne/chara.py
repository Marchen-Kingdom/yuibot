...
import yuibot
from yuibot import R, log, sucmd, util
from yuibot.typing import CommandSession

from . import _pcr_data

logger = log.new_logger("chara", yuibot.config.DEBUG)
UNKNOWN = 1000
UnavailableChara = {
    1067,  # 穗希
    1069,  # 霸瞳
...
class Chara:
    ...
    def name(self):
        return (
            ...
            else _pcr_data.CHARA_NAME[UNKNOWN][0]
        )
